...
> 版本：V1.0  
> 编制日期：2026-08-14<br>
> 增量更新：2026-08-28（精确店名内部键、长沙城市匹配规则及换货双动作流程）<br>
> 适用平台：抖音  
...
![换货待商家收货列表](./assets/抖音退款Agent/换货流程/11_换货待商家收货.png)

![换货售后待商家处理详情](./assets/抖音退款Agent/换货流程/10_换货售后待商家处理.png)
...
![原订单补发入口](./assets/抖音退款Agent/换货流程/9_换货原订单点击补发.png)

![补发基本信息](./assets/抖音退款Agent/换货流程/8_换货填写补发基本信息.png)

![替换商品明细](./assets/抖音退款Agent/换货流程/7_换货替换商品明细.png)

![选择目标规格](./assets/抖音退款Agent/换货流程/6_换货选择对应尺码.png)

![确认商品规格](./assets/抖音退款Agent/换货流程/5_换货确认商品规格.png)

![确认零元支付](./assets/抖音退款Agent/换货流程/4_换货确认支付信息.png)
...
![选择补发单手工配货](./assets/抖音退款Agent/换货流程/3_换货选择补单手工配货.png)

![核实仓库库存](./assets/抖音退款Agent/换货流程/2_换货核实仓库库存.png)

![生成配货单](./assets/抖音退款Agent/换货流程/1_换货生成配货单.png)
